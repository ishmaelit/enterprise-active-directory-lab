...
## Overview
This project simulates an enterprise Active Directory environment using Windows Server 2022, DNS services, and domain-integrated Windows 11 clients within a virtualized VirtualBox lab
